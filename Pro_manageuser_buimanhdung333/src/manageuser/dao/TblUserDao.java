...
public interface TblUserDao extends BaseDao {
	...
	/**
	 * Lấy về một UserID tương ứng với email trong DB
	 *
	 * @param email
	 * @return UserID
	 * @throws ClassNotFoundException 
	 */
	int getUserIdByEmail(String email) throws ClassNotFoundException, SQLException ;
	
	/**
	 * Lấy về một user có login_name truyền vào
	 * 
	 * @param userName : login_name của user
	 *            
	...
	/**
	 * Check email thoa man hay khong
	 * 
	 * @param email
	 * @param userId
	 * @return email của user
	 ...
	 * @throws ClassNotFoundException
	 */
	boolean checkEmailByUserId(String email, int userId) throws SQLException, ClassNotFoundException;

	/**
	 * Kiểm tra loginName đã tồn tại hay chưa
	 * 
	 * @param loginName : tên đăng nhập muốn kiểm tra tồn tại
	 *            
	 * @return loginName của user
	 * 
	 * @throws SQLException : lỗi thao tác với CSDL
	 *             
	 * @throws ClassNotFoundException
	 *             
	 */
	 ...
	 *            
	 * @param fullName : tên nhóm tìm kiếm
	 *            
	...
	int getTotalUser(int groupId, String fullName, int year, int month, int date) throws SQLException, ClassNotFoundException;
	 ...
	 * Update user
	 * 
	 * @param tblUser : thông tin user cần update
	 *            
